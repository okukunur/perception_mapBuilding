...
DEFAULT_PUBLISHER_TOPIC = "/cmd_vel"
DEFAULT_SUBSCRIBER_TOPIC = "/scan"

DEFAULT_WALL_DISTANCE = 0.8    # Distance from the wall
DEFAULT_MAX_SPEED = 0.4    # Maximum speed of robot
DEFAULT_P = 1.2    # Proportional constant for controller
DEFAULT_D = 0.2    # Derivative constant for controller
...
class NodeWallFollowing(object):
    ...
    def publish_message(self):
        ...
        if self.dist_front < self.wall_dist:
            ...
            msg.linear.x = 0.2*self.max_speed
        else:
    ...
    def update_parameters(self):
        ...
        self.max_speed = rospy.get_param("/wall_following/maxSpeed", self.maxSpeed)
        self.p = DEFAULT_P
